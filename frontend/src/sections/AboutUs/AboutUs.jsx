        ...
        <div className="col-md-6 mt-5">
          ...
          <div className="mt-2 about-section">
            ...
            <p>
              ...
              possible. Whether you're looking for your next vehicle or looking
              to sell your car, we offer a range of services to help you make
              informed decisions.
            </p>
            <p>
              Our platform connects car buyers with trusted dealers in Kerala,
              giving you the opportunity to browse a wide selection of vehicles,
              from affordable cars to premium options, all in one place. Our
              easy-to-use interface makes the buying and selling process simple
              and stress-free.
            </p>
            <p>
              Join the <span>WheelzLoop</span> community today and take the
              first step towards finding the perfect car or selling your vehicle
              with confidence!
            </p>
          </div>
        </div>
